...
\setlength\titlebox{10cm}  % modifier la hauteur du `\maketitle`
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=\columnwidth]{img/image4.png}
...
%
% => solution: en ligne de commande, compiler avec `bibler` le
% fichier `.aux`: 
% `biber ./humanistica_abstract_20230215.aux`
\bibliography{humanistica.bib}
